...
5. **Only your modifications to bucketmap must be open-sourced**, not your entire codebase.
   You are free to publish solely the modified parts of bucketmap (e.g. as a standalone
...
|---|---|
| You fork or patch bucketmap and use it publicly | ✅ Publish your bucketmap modifications (e.g. a patch repo) |
| You fork or patch bucketmap and expose it over a network | ✅ Publish your bucketmap modifications (e.g. a patch repo) |
| You use bucketmap as a dependency (`go get github.com/FCAgreatgoals/bucketmap`) | ❌ No obligation, your code stays yours |
| You run the bucketmap command against your own API, proxy or bot | ❌ No obligation, your code stays yours |
| You wrap bucketmap without modifying it | ❌ No obligation, your code stays yours |
| You have private business logic alongside bucketmap modifications | ✅ Only publish the bucketmap modifications, keep the rest private |
